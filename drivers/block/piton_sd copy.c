...
static blk_status_t piton_block_request(struct blk_mq_hw_ctx *hctx, const struct blk_mq_queue_data *bd) {
...
static struct blk_mq_ops piton_queue_ops = {
   .queue_rq = piton_block_request,
};
